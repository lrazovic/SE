 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://server.soap/", wsdlLocation = "http://localhost:8080/ProfessorManagement?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://server.soap/", "ExamImplService");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://server.soap/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap/", "ExamImplPort"), Exam.class, features);
    }
